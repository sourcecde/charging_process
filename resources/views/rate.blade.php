                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="transaction" placeholder="Enter Transaction" class="form-control">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="timestampStart" placeholder="Enter Time Start" class="form-control">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="timestampStop" placeholder="Enter Time End" class="form-control">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="meterStart" placeholder="Enter Meter Start" class="form-control">
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <input type="text" name="meterStop" placeholder="Enter Meter End" class="form-control">
...
<label>Enter Energy:</label><br />
<input type="text" name="energy" placeholder="Enter Energy" required/>
<br /><br />
<label>Enter Time Rate:</label><br />
<input type="text" name="time" placeholder="Enter Time Rate" required/>
<br /><br />
<label>Enter Transaction:</label><br />
<input type="text" name="transaction" placeholder="Enter Transaction" required/>
<br /><br />
<label>Enter Time Start:</label><br />
<input type="text" name="timestampStart" placeholder="Enter Time Start" required/>
<br /><br />
<label>Enter Time End:</label><br />
<input type="text" name="timestampStop" placeholder="Enter Time End" required/>
<br /><br />
<label>Enter Meter Start:</label><br />
<input type="text" name="meterStart" placeholder="Enter Meter Start" required/>
<br /><br />
<label>Enter Meter Stop:</label><br />
<input type="text" name="meterStop" placeholder="Enter Meter Stop" required/>
<br /><br />
